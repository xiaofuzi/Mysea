...
class FlightsControllerTest < ActionController::TestCase
  ...
  test "should update flight" do
    put :update, :id => @flight, :flight => { :arrival => @flight.arrival, :baggage_allowance => @flight.baggage_allowance, :capacity => @flight.capacity, :departure => @flight.departure, :destination => @flight.destination }
    assert_redirected_to flight_path(assigns(:flight))
  end
